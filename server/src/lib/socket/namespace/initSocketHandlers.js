  ...
  */
  ...
  namespaces.forEach((namespace) => {
    ...
    io.of(namespace.endpoint).on(actionTypes.CONNECTION, (socket) => {
      ...
      socket.on(actionTypes.SOCKET_TO_ROOM, (messageObj) => {
        ...
        io.of(namespace.endpoint).in(currentRoom).emit(actionTypes.IO_TO_ROOM, messageObj);
      ...
      socket.on(actionTypes.SOCKET_TO_SERVER, (dataFromClient) => {
        ...
        io.emit(actionTypes.IO_TO_CLIENTS, { text: dataFromClient.text });
      });
